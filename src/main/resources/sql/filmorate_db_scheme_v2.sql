...
CREATE TABLE "film_rating" (
                          "film_id" int NOT NULL ,
                          "rating_id" int  NOT NULL,
                          CONSTRAINT "pk_film_raiting" PRIMARY KEY (
                                                                  "film_id","rating_id"
                              )
);
...
ALTER TABLE "film_rating" ADD CONSTRAINT "fk_film_raiting_film_id" FOREIGN KEY("film_id")
    REFERENCES "film" ("film_id") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "film_rating" ADD CONSTRAINT "fk_film_raiting_rating_id" FOREIGN KEY("rating_id")
